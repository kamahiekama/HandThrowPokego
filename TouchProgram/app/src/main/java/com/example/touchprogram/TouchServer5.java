            ...
            try {
                ...
                try {
                    ...
                    while(line != null) {
                        ...
                        int operation = MotionEvent.ACTION_CANCEL;
                        switch(ss[0]){
                            case "d":       // down
                                operation = MotionEvent.ACTION_DOWN;
                                break;
                            case "m":       // move
                                operation = MotionEvent.ACTION_MOVE;
                                break;
                            case "u":       // up
                                operation = MotionEvent.ACTION_UP;
                                break;
                        }
                        ...
                        if (operation != MotionEvent.ACTION_CANCEL){
                            Motion(operation, x, y, 0);
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
